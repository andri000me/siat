...
<?= $this->session->flashdata('flash')  ?>.
            ...
            <div class="row">
                <div class="col-lg">
                    <a href="<?= base_url(); ?>snilai" class="btn btn-primary mb-3">Kembali</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <input type="text" size="5" id="" name="nilai">
                                ...
                                <td><?= $i['rata']; ?></td>
                                <td><a href="<?= base_url(); ?>snilai/lihattugas/<?=$i['idratanilai'];?>">
                                    <?php
                                    $sql = "    SELECT idbanyaknilai
                                                FROM `banyaknilai`
                                                WHERE fkidratanilai = $ratanilai
                                            ";
